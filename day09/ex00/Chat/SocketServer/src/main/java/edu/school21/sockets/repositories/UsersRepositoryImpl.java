...
public class UsersRepositoryImpl implements UsersRepository{
    ...
    public void save(User entity) {
        jdbcTemplate.update("insert into userTable (userName, password) values (?, ?)", entity.getUserName(), entity.getPassword());
    }

    @Override
    public void update(User entity) {
        jdbcTemplate.update("update userTable set userName=?, password=? where id=?", entity.getUserName(),
    ...
    public Optional<User> findByUserName(String userName) {
        return jdbcTemplate.query("select * from userTable where userName=?", new Object[]{userName},
